...
export const INITIAL_SETTINGS: SiteSettings = {
  ...
  keywords: 'top 10 nha cai, nha cai uy tin, danh gia nha cai, cong game bai doi thuong, keovip247, link vao nha cai khong bi chan, khuyen mai nha cai',
  logo: '/images/logo.png',
  favicon: '/favicon.ico',
  ogImage: 'https://images.unsplash.com/photo-1518609878373-06d740f60d8b?w=1200&h=630&auto=format&fit=crop&q=80',
  promoBannerUrl: '',
  promoBannerLink: '',
  ...
  facebookUrl: 'https://facebook.com/keovip247',
  youtubeUrl: 'https://youtube.com/@keovip247',
  ...
  heroBadge: 'Cập Nhật Tháng 8/2026 • Thẩm Định Độc Lập',
  ...
  stat1Value: '100%',
  stat1Label: 'Giấy Phép Quốc Tế',
  stat2Value: '< 5 Phút',
  stat2Label: 'Rút Tiền Siêu Tốc',
  stat3Value: '199K Free',
  stat3Label: 'Tặng Thưởng Tân Thủ',
  stat4Value: '50.000+',
  stat4Label: 'Cược Thủ Tin Chọn',
  googleVerification: '',
  customHeadScripts: '',
  customBodyScripts: '',
};
